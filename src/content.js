...
const content = {
  ...
  vendors: {
    ...
    list: [
      { name: "Cari and Paul Real Estate ", url: "https://www.instagram.com/cariandpaulrealestate/" },
      { name: "Coptic Crafted Co. ", url: "https://www.instagram.com/copticcraftedco/" },
      { name: "Coptic Orphans ", url: "https://www.copticorphans.org" },
      { name: "EmberRoot Hot Sauce", url: "https://www.instagram.com/emberrootkitchen/" },
      { name: "Gigy Oweda", url: "" },
      { name: "Khalil Jewelry ", url: "" },
      { name: "Lumie.Art", url: "https://www.lumieart.ca/" },
      { name: "Glamorous Jewelry", url: "" },
      { name: "Marianne Botros Headscarves", url: "https://mariannebotros.com/" },
      { name: "MM Jewelry ", url: "" },
      { name: "Pharaoh's choice ", url: "" },
      { name: "Princess Jewelry ", url: "" },
      { name: "Silver Rose Jewelry", url: "" },
      { name: "St. Andrew's Insurance Brokers", url: "https://www.instagram.com/insurewithmarlia/" },
      { name: "The Nile Valley ", url: "" },
      { name: "The World Light ", url: "https://theworldlight.com/" },
    ],
  },
